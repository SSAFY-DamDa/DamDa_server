...
public class JourneyController {
	...
	public ResponseEntity<Map<String, Integer>> registerJourney(@RequestBody JourneyDto journeyDto,
	...
	public ResponseEntity<String> registerJourneyDetail(@RequestBody Map<String, List<TripDto>> journeyDetail,
		...
		try {
			...
			return new ResponseEntity<>("Error registering journey detail: " + e.getMessage(),
